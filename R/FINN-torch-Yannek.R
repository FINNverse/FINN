...
init_FINN = function(
  ...
  self$nnRegEnv = self$_build_NN(input_shape=env, output_shape=sp, hidden=hidden_reg, activation="selu", bias=list(FALSE), dropout=-99, last_activation = "relu")
  self$nnRegEnv$to(self.device)
  self$nnGrowthEnv = self$_build_NN(input_shape=env, output_shape=sp, hidden=hidden_growth, activation="selu", bias=list(FALSE), dropout=-99)
  self$nnGrowthEnv$to(self.device)
  self$nnMortEnv = self$_build_NN(input_shape=env, output_shape=sp, hidden=hidden_mort, activation="selu", bias=list(FALSE), dropout=-99)
