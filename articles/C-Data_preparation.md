...
a hand-rolled rate can otherwise book a death against the species a tree
*ended* as while the denominator counted the species it *started* as,
and report more deaths than trees.
