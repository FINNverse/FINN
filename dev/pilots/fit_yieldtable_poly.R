...
m <- finn(
  ...
  growth_process       = createProcess(~ ekl, FINN::growth_poly, optimizeSpecies = TRUE,
                                       optimizeEnv = TRUE, custom_parameters = list(poly_coef = rep(0, 4))),
...
ggsave("dev/pilots/fit_yieldtable_poly.png", p, width = 8, height = 5, dpi = 130)
cat("wrote dev/pilots/fit_yieldtable_poly.png\n")
