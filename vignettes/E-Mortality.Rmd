...
0.5 is coin-flipping, 1.0 is perfect ranking. The **holdout** rows are the ones
that count, and they should be read against the `deaths` column beside them: this
is a few hundred events, so treat small differences between the two models as
noise rather than as a result. Refitting with a different seed moves these numbers.
